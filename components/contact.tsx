  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setStatusMessage(data.message || "Message sent successfully! You should receive a confirmation email shortly.")
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                {submitStatus === "success" && (
                  ...
                  >
                    ...
                    <span className="text-dill-green font-outfit font-medium">{statusMessage}</span>
                  </div>
                )}
                ...
                {submitStatus === "error" && (
                  ...
                  >
                    ...
                    <span className="text-cherry-red font-outfit font-medium">{statusMessage}</span>
                  </div>
                )}
              </form>
            </div>
