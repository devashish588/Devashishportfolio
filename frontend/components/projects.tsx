...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      github: "https://github.com/devashish588/rfid-attendance-system",
      demo: "#",
    ...
    },
    {
      ...
      github: "https://github.com/devashish588/power-bi-dashboard",
      demo: "#",
    ...
    },
    {
      ...
      description:
        "Built predictive models using scikit-learn for business forecasting. Implemented feature engineering and model optimization techniques.",
      technologies: ["Python", "Scikit-learn", "Pandas", "NumPy", "Matplotlib"],
      github: "https://github.com/devashish588/ml-prediction-model",
      demo: "#",
    ...
    },
    {
      ...
      description:
        "Developed an integrated smart home system using ESP32 and various sensors. Created mobile app for remote monitoring and control.",
      technologies: ["ESP32", "Arduino", "React Native", "Firebase", "Sensors"],
              ...
              >
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <a
                      href={project.github}
                      className="flex items-center justify-center space-x-2 px-6 py-3 professional-card text-muted-foreground hover:text-aura-indigo rounded-xl transition-all duration-300 font-outfit font-medium hover:border-aura-indigo/50 focus:border-aura-indigo focus:ring-2 focus:ring-aura-indigo/20 focus:outline-none"
